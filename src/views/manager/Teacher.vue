<template>
    ...
    <div>
      <el-table :data="teacher" stripe :header-cell-style="{ backgroundColor: 'aliceblue', color: '#666' }" @selection-change="handleSelectionChange">
      ...
      load() {
        request.get('/user/selectByPage', {
          ...
          if (response && response.data) {
            this.teacher = response.data.list;  // 假设后端返回的数据中有一个用户列表是 'list'
